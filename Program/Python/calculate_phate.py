...
if __name__ == "__main__":
    ...
    input_adata.obsm[step00.projection_key] = phate.PHATE(n_components=2, knn=5, decay=15, t="auto", gamma=1.0, n_pca=None, knn_dist="euclidean", mds_dist="euclidean", mds="metric", n_jobs=args.cpus, random_state=42, verbose=True).fit_transform(projection_input)
    print(input_adata)
